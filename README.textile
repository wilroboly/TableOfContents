...
* <code>ignoreTagsClass</code>: <code>".class"</code><br />Should you wish to have certain header tags not be included, the class used here will have the TOC ignore these in the build.